    ...
    function loadDBComplete() {
              ...
              controller.on('updateNode', function (node) {
                  ...
                  let updateNodeDB = function () {
                      ...
                      self.db.collection('node').findOneAndUpdate({_id: node._id}, { $set: doc }, function (err, newDoc) {
                          assert.equal(err, null);
              ...
              controller.on('updateSensor', function (sensor) {
                  ...
                  let updateSensorDB = function () {
                      ...
                      self.db.collection('sensor').findOneAndUpdate({_id: sensor._id}, { $set: doc }, function (err, newDoc) {
                          assert.equal(err, null);
